# Don't Remove Credit Tg - @AJxBotZ  
...
async def main(bot: Client, message: Message):
    ...
    phone_number_msg = await bot.ask(chat_id=user_id, text="<b>Please send your phone number which includes country code. Warning Don't Use Your Main Account</b>\n<b>Example:</b> <code>+13124562345, +9171828181889</code>")
